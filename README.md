...
> Tested live against a **Hospital Management System** codebase (React + Spring Boot) using the **Google ADK UI v1.31.1**.

![Codebase RAG Agent — Google ADK UI Demo](docs/image.png)
